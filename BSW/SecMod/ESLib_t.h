...
/* Pointer to byte(s) usually located in ROM but moved to RAM for special use-case, e.g. RSA key data */
CRYPTOCV_P2CONST_TYPE( CRYPTOCV_NONE, eslt_Byte ) eslt_pRomByte;
