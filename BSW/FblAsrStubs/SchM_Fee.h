 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  SchM_Fee.h
 *        Config:  EIP_GlobalB.dpa
 *   ECU-Project:  EPS
 *
 *     Generator:  MICROSAR RTE Generator Version 4.8.1
 *                 RTE Core Version 1.8.1
 *       License:  Unlimited license CBD1500636 for Nexteer Automotive Corporation
 *
