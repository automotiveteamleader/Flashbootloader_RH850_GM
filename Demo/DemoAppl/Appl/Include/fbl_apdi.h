 ...
 *  --------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY (KbFbl_apdiFrameOem.c, GM SLP5 und SLP6)
 *  --------------------------------------------------------------------------------------------------------------------
 *  Version    Date        Author  Change Id        Description
 *  --------------------------------------------------------------------------------------------------------------------
 *  05.00.00   2014-01-31  AWh                      First release
 *  05.01.00   2014-07-14  AWh                      SLP6: Add DIDs defined for Global B
 *  05.02.00   2015-01-15  AWh     ESCAN00078960    SLP6: Make allowed Tester addresses configurable
 *                                 ESCAN00080504    SLP6: Add callback to get multiple node address
 *  05.02.01   2015-06-12  AWh     -                Update Header Information
 *  05.03.00   2016-03-16  Shs     ESCAN00088937    Added support for PATAC SLP2
 *  05.03.01   2016-03-31  Shs     ESCAN00089151    No changes
 *  05.03.02   2016-06-10  Shs     ESCAN00090494    Moved compatibility defines to diag header file
 *  05.04.00   2016-06-30  Shs     ESCAN00090792    Support configuration switch FBL_CW_ENABLE_MULTIPLE_NODES
 *  05.05.00   2016-07-25  AWh     ESCAN00091150    No changes
 *  05.05.01   2017-03-30  AWh     ESCAN00094560    No changes
 **********************************************************************************************************************/
/***********************************************************************************************************************
 *  --------------------------------------------------------------------------------------------------------------------
 *  REVISION HISTORY
...
/* ---  Module Version --- */
/* ##V_CFG_MANAGEMENT ##CQProject : FblKbApi_FrameDiag_GM CQComponent : Implementation */
#define FBLKBAPI_FRAMEDIAG_GM_VERSION           0x0505u
#define FBLKBAPI_FRAMEDIAG_GM_RELEASE_VERSION   0x01u
...
#  define ApplFblGetNodeAddress() ((fblEcuHandle == 0)? DIAG_NODE_ADDRESS : DIAG_NODE_ADDRESS_2ND)
# else
#  define ApplFblGetNodeAddress() (DIAG_NODE_ADDRESS)
# endif

#if !defined( FBL_MAX_DID_COUNT )
# define FBL_MAX_DID_COUNT 10
#endif

/* DIDs are partly not defined in specifications this is based on.
 * Some of the information Vector does not have should be defined for your ECU in your CRTS.
 *
 * Please verify and change DIDs as required.
 * Some of the DIDs are pre-implemented (with the help of the knowledge we have on it at this time),
 * add what you require additionally.
 *
 * Please carefully test your DID requirements.
 */

/* The following 3 are pre-implemented */
#define kDiagDidProgrammedStateIndicator          0xF0F0u
#define kDiagDidProgramingErrorCode               0xF0F1u
#define kDiagDidBootInitializationStatus          0xF0F2u

/* kDiagDidEcuId is read from ApplFblNVMReadECUID(). ApplFblNVMReadECUID() reads from FblHeader per default and needs to
 * get updated unless unless FblHeader contains a unique ECUID per ECU (e.g. through patched hex file). */
#define kDiagDidEcuId                             0xF0F3u

/* kDiagDidSignatureBypassAT reads from ApplFblNVMReadSBATicket() that has to return the SBA ticket. */
#define kDiagDidSignatureBypassAT                 0xF0F4u

/* kDiagDidBInfoSubjandECUName reads from FblHeader the required elements. */
#define kDiagDidBInfoSubjandECUName               0xF0F6u

/* Info: 0xF100u/0xF101u - 0xF126u/0xF127u may be added for Swmi 11-30 (not pre-implemented)*/

/* The following kDiagDidBootSwId is not pre-implemented (check CTRS) */
#define kDiagDidBootSwId                          0xF180u

/* kDiagDidDiagnosticAddress is pre-implemented */
#define kDiagDidDiagnosticAddress                 0xF1B0u

/* GM defined DIDs to allow reading out SWMI (pre-implemented) */
#define kDiagDidBootSoftwarePartNr                0xF1C0u
#define kDiagDidSwmi01                            0xF1C1u
#define kDiagDidSwmi02                            0xF1C2u
#define kDiagDidSwmi03                            0xF1C3u
#define kDiagDidSwmi04                            0xF1C4u
#define kDiagDidSwmi05                            0xF1C5u
#define kDiagDidSwmi06                            0xF1C6u
#define kDiagDidSwmi07                            0xF1C7u
#define kDiagDidSwmi08                            0xF1C8u
#define kDiagDidSwmi09                            0xF1C9u
#define kDiagDidSwmi10                            0xF1CAu

/* The following 2 are not pre-implemented (check CTRS) */
#define kDiagDidGMEndModelPartNumber              0xF1CBu
#define kDiagDidGMBaseModelPartNumber             0xF1CCu

/* GM defined DIDs to allow reading out Alpha code (pre-implemented) */
#define kDiagDidBootSoftwareAlpha                 0xF1D0u
#define kDiagDidAlpha01                           0xF1D1u
#define kDiagDidAlpha02                           0xF1D2u
#define kDiagDidAlpha03                           0xF1D3u
#define kDiagDidAlpha04                           0xF1D4u
#define kDiagDidAlpha05                           0xF1D5u
#define kDiagDidAlpha06                           0xF1D6u
#define kDiagDidAlpha07                           0xF1D7u
#define kDiagDidAlpha08                           0xF1D8u
#define kDiagDidAlpha09                           0xF1D9u
#define kDiagDidAlpha10                           0xF1DAu

/* The following 3 are not pre-implemented (check CTRS) */
#define kDiagDidGMEndModelPartNumberAlpha         0xF1DBu
#define kDiagDidGMBaseModelPartNumberAlpha        0xF1DCu
#define kDiagDidGMSwModuleIdDataIdentifiers       0xF1DDu

/* Ensure backward compatibility to FblDiag_SecHdr prior to 03.xx.xx */
#if (FBLDIAGHDR_GM_VERSION < 0x0300u)
# define FblHdrGetReportablePecError()   (errPecErrorCode)
...
# define FblHdrPollingTaskVoid()         (void)FblRealTimeSupport()
# define HDR_NO_PP_ADDRESS_DEFINED       NO_PP_ADDRESS_DEFINED
# define HDR_NO_HEADER_ADDR_DEFINED      NO_HEADER_ADDR_DEFINED
# define HdrErr_Compression              Err_Compression
