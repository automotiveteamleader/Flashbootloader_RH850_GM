 ...
 *  01.02.00   2017-01-11  DKl     ESCAN00093522    Use V_COMP switches
 **********************************************************************************************************************/
...
#if ( FBLVTABAPPL_RH850_VERSION != 0x0103 ) || \
...
V_MEMROM0 V_MEMROM1 vuint32 V_MEMROM2 ApplIntJmpTable[2] = {APPLVECT_FROM_APPL, RESET_ENTRY_POINT}; /* PRQA S 0305, 0685, 0428 */ /* MD_FblVtabApplRh850_JmpTable */
